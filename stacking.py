...
test_data_set=[]
test_id=[]
skf = KFold(n_splits=5, shuffle=False).split(train_data)
...
other_params = {'learning_rate': 0.1, 'n_estimators': 200, 'max_depth': 3,'min_child_weight': 5,'seed': 0,
               'subsample': 0.8, 'colsample_bytree': 0.8,'gamma': 0.1,'reg_alpha': 0,'reg_lambda': 1,'eval_metric':"mae",'verbose':1}
